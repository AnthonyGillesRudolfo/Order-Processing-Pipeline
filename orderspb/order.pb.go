...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x06orders\"\x8f\x01\n" +
	"\x05Order\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vcustomer_id\x18\x02 \x01(\tR\n" +
	"customerId\x12(\n" +
	"\x05items\x18\x03 \x03(\v2\x12.orders.OrderItemsR\x05items\x12+\n" +
	"\x06status\x18\x04 \x01(\x0e2\x13.orders.OrderStatusR\x06status\"G\n" +
	"\n" +
	"OrderItems\x12\x1d\n" +
	"\n" +
	...
	"customerId\x12(\n" +
	"\x05items\x18\x02 \x03(\v2\x12.orders.OrderItemsR\x05items\"0\n" +
...
var file_order_proto_goTypes = []any{
	...
	(*OrderItems)(nil),          // 2: orders.OrderItems
...
var file_order_proto_depIdxs = []int32{
	2, // 0: orders.Order.items:type_name -> orders.OrderItems
	0, // 1: orders.Order.status:type_name -> orders.OrderStatus
	2, // 2: orders.CreateOrderRequest.items:type_name -> orders.OrderItems
