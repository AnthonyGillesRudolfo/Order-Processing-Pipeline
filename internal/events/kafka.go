...
// NewProducer creates a producer using brokers from KAFKA_BROKERS or localhost:9092.
// Kept for backward compatibility in parts of the codebase that don't use DI yet.
func NewProducer() *Producer {
    ...
    return NewProducerWithBrokers(brokers)
}

// NewProducerWithBrokers constructs a producer for the provided broker list.
